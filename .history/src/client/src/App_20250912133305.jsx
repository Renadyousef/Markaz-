...
import "./App.css";
import HomePage from "./components/homePage/Home.css";
...
export default function App() {
  ...
  // تزامن التوكن بين تبويبات المتصفح
  useEffect(() => {
    const onStorage = (e) => {
